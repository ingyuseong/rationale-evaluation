...
PYTHONPATH=$PY_PATH python rationale_benchmark/metrics.py --split test --data_dir data --results output/test_decoded.jsonl --score_file output/test_scores.json
